...
void loop() {
  ...
  if(Serial2.available()){
    ...
    switch(count){
      case 0:
      temp_bytes[0] = value;
      Serial.print("Low Temp Raw Is: ");
      Serial.println(temp_bytes[0]);
      count += 1;
      break;
      case 1:
      temp_bytes[1] = value;
      Serial.print("High Temp Raw Is: ");
      Serial.println(temp_bytes[1]);
      count += 1;
      break;
      case 2:
      humid_bytes[0] = value;
      Serial.print("Low Humid Raw Is: ");
      Serial.println(humid_bytes[0]);
      count += 1;
      break;
      case 3:
      humid_bytes[1] = value;
      Serial.print("High Humid Raw Is: ");
      Serial.println(humid_bytes[1]);
      count += 1;
      break;
      case 4:
      pressure_bytes[0] = value;
      Serial.print("Pressure XLSB Raw Is: ");
      ...
      Serial.print("Pressure LSB Raw Is: ");
      ...
      Serial.print("Pressure MSB Raw Is: ");
